...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO comment1 = new CommentDTO(null, "Tenha um ótimo dia", sdf.parse("23/03/2018"), new AuthorDTO(bob));
		CommentDTO comment2 = new CommentDTO(null, "Aproveite", sdf.parse("22/03/2018"), new AuthorDTO(maria));
		CommentDTO comment3 = new CommentDTO(null, "Boa viagem, mano!", sdf.parse("21/03/2018"), new AuthorDTO(alex));
